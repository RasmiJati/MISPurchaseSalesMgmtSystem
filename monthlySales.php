    ...
    <div id="layoutSidenav_content">
      <main>
        <div class="container-fluid px-4">
          <h1 class="mt-4">Monthly Sales Report</h1>
...
?>
          ...
          <div class="card mb-4">
            ...
            <table id="datatablesSimple">
                ...
                <tbody>
                  <?php
                  $run = mysqli_query($con, "SELECT  ProductId , date_format(Date,'%M,%Y'), Name, sum(Quantity), round(sum(TotalAmount),0) from sales group by  date_format(Date,'%M,%Y') order by  month(Date)");
